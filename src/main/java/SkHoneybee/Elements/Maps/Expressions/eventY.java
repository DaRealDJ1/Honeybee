...
public class eventY extends SimpleExpression<Double> {
    static {
        Skript.registerExpression(eventY.class, Double.class, ExpressionType.SIMPLE, "event-y");
    }
    ...
    protected Double[] get(Event e) {
        return new Double[]{Custom.eventY};
    }
}
