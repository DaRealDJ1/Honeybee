...
public class eventID extends SimpleExpression<Double> {
    static {
        Skript.registerExpression(eventID.class, Double.class, ExpressionType.SIMPLE, "event-id");
    }
    ...
    protected Double[] get(Event e) {
        return new Double[]{Custom.eventID};
    }
}
